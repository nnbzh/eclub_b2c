...
')
     ...
     */ 
        ...
        {
                        /** @var \App\Helpers\StringFormatterHelper $instance */
                        return $instance->onlyDigits($str);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \App\Helpers\StringFormatterHelper $instance */
                        return $instance->maskPhone($phone);
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function process($products, $cityId, $pharmacyNumber = null, $inStock = true)
        {
                        /** @var \App\Helpers\ProductPreprocessorHelper $instance */
                        return $instance->process($products, $cityId, $pharmacyNumber, $inStock);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function getExistingInPharmacy($products, $pharmacy)
        {
                        /** @var \App\Helpers\ProductPreprocessorHelper $instance */
                        return $instance->getExistingInPharmacy($products, $pharmacy);
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function to($receiver = null)
        {
                        /** @var \App\Services\Sms\SmsService $instance */
                        return $instance->to($receiver);
        }
...
namespace  { 
            ...
            class StringFormatter extends \App\Facades\Helpers\StringFormatter {}
...
namespace Backpack\CRUD\app\Library\CrudPanel { 
            class CrudFilter extends \App\Overrides\CrudFilter {}
